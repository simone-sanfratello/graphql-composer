...
function collectQueries ({
  ...
  if (!field) {
    console.log(' ::: no fieldId > ', fieldId)
    ...
    addDeferredQuery({ deferreds, context, path, queryNode, querySelection, field, selectionFieldName, alias })
...
function addDeferredQuery ({ deferreds, context, path, queryNode, querySelection, field, selectionFieldName, alias }) {
  ...
  addDeferredQueryField(deferred, selectionFieldName || fieldName, querySelection, alias)
}
